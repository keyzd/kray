...
public:
	Mat2();
	Mat2(double col0_0, double col0_1, double col1_0, double col1_1);
	Mat2(double diag);
	...
	Mat2 operator*(double t) const;
	const Mat2& operator*=(double t);
...
inline Mat2 operator*(const double t, const Mat2 &m) {
...
inline Mat2::Mat2(double col0_0, double col0_1, double col1_0, double col1_1) {
	columns[0] = Vec2(col0_0, col0_1);
	columns[1] = Vec2(col1_0, col1_1);
}

inline Mat2::Mat2(double diag) {
...
inline Mat2 Mat2::operator*(double t) const {
	return Mat2(columns[0].x*t, columns[0].y*t, columns[1].x*t, columns[1].y*t);
}

inline const Mat2& Mat2::operator*=(double t) {
	columns[0] *= t;
	columns[1] *= t;
	return *this;
}
