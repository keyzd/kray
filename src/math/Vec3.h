...
public:
	...
	Vec3(const Vec2& xy, double a_z);
	Vec3(double a_x, const Vec2& yz);
...
inline Vec3::Vec3(double a_x, double a_y, double a_z) {
	x = a_x; y = a_y; z = a_z;
}
...
inline Vec3::Vec3(const Vec2& xy, double a_z) {
	x = xy.x;
	y = xy.y;
	z = a_z;
}

inline Vec3::Vec3(double a_x, const Vec2& yz) {
	x = a_x;
	y = yz.x;
	z = yz.y;
}
...
inline Vec3 Vec3::operator+(const double t) const {
...
inline const Vec3& Vec3::operator*=(const double t) {
	x *= t; y *= t; z *= t;
	return *this;
}
